    ...
    public class DadosGeograficosMigration_v1 : Migration
    {
        public override void Up()
        {
    		Create.Table("Regioes")
		    	...
		    	.WithColumn("NomeRegiao").AsString().NotNullable();

    		Create.Table("Estados")
	    		.WithColumn("SiglaEstado").AsString().NotNullable().PrimaryKey()
                .WithColumn("NomeEstado").AsString().NotNullable()
                .WithColumn("NomeCapital").AsString().NotNullable()
